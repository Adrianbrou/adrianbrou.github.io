...
const Links = () => {
    const links = [
        ...
        },
        {
            ...
            icon: FaKaggle,
            description: 'Data science projects, notebooks, and competition submissions',
            color: 'bg-cyan-500',
        },
        {
            name: 'Notion',
            url: 'https://notion.so/',
            icon: SiNotion,
            description: 'Public learning notes, project documentation, and knowledge base',
        ...
        },
        {
            ...
            icon: FaTwitter,
            description: 'Thoughts on tech, development tips, and industry news',
            color: 'bg-sky-500',
        },
        {
            name: 'Resume',
